...
namespace MVC_AdopterUnDev.Handlers
{
    ...
    {
        public static DeveloperList ToListDev(this BLL_AdopteUnDev.Models.Developer dev)
        {
        ...
        public static DeveloperDetails ToDetailsDev(this BLL_AdopteUnDev.Models.Developer dev)
        {
            if (dev is null) return null;
